<template>
    <div class="reservation-form p-4">
      ...
      <div v-else-if="step === 2">
        ...
        <!-- Bouton de soumission sans attribution de disabled pour permettre l'affichage des erreurs -->
        <button
  ...
  // Utilisation dynamique de la date d'aujourd'hui
  // (appel direct de getTodayNoumea() dans les bindings du template et la validation)
