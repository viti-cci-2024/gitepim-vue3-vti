<template>
  <div class="reservation-cheval p-4">
    ...
    <div v-else-if="step === 2">
      ...
      <!-- Toast pour avertir si le max de sélection de chevaux est atteint -->
...
// ===== Toast pour dépasser le nombre max de chevaux sélectionnables =====
...
// Filtrer les chevaux disponibles (exclure les moniteurs et ceux déjà utilisés pour ce créneau)
...
// Soumission de la réservation de randonnée (Étape 2)
...
<style scoped>
/* Les effets de hover, de grossissement et de grisage sont gérés via les classes Tailwind dans le template */
</style>
