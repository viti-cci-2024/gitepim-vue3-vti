<template>
  <div class="reservation-kayak p-4">
    ...
    <div v-else-if="step === 2">
      ...
      <div v-if="participants > 0" class="mb-4 p-4 border rounded shadow-md">
        ...
        <div v-if="remainingParticipants > 0">
          ...
          <div class="flex gap-4">
            <!-- Option double: autorisée si au moins 2 places restent et disponibilité locale -->
            ...
            <!-- Option simple: autorisée si disponible -->
      ...
      <!-- Bouton de soumission, uniquement si l'allocation est complète -->
...
const currentSelection = ref('');      // choix temporaire pour la cascade
...
// ===== Mapping pour les images des kayaks =====
function getKayakImage(type) {
  // Supposons que vous ayez deux images : KayakDouble.jpg et KayakSimple.jpg
  return type === 'double' ? `/kayak/KayakDouble.jpg` : `/kayak/KayakSimple.jpg`;
}
